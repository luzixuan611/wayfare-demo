(() => {
  ...
  const translate = value => {
    ...
    const sentences = {'Set actual cost':'填写实际花费','Open listing':'查看地点','Flexible':'弹性安排','Near your stay.':'住宿附近。','A relaxed final meal before checkout.':'退房前轻松吃最后一餐。','A final meal near your stay.':'住宿附近的最后一餐。','A casual first stop near your stay.':'抵达后在住宿附近轻松停留。','A well-reviewed option near your stay.':'住宿附近评价不错的选择。','A short, easy stop before departure.':'出发前轻松短暂停留。','Allow extra time for luggage, traffic, and the airport or station.':'为行李、交通以及机场或车站预留充足时间。','Allow extra time for luggage and traffic.':'为行李和交通预留充足时间。'};
